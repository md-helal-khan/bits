		...
		<div class="job-postdetails post-resume">
			...
			<div class="row">
				<div class="col-md-12 clearfix">
					<sf:form action="${pageContext.request.contextPath}/ApplyToJob" method="POST" id="applyToJob" commandName="applicant" enctype="multipart/form-data">
						<!-- Hidden Field -->
						...
						<fieldset>
							...
							<h2 class="title">চাকরির আবেদন ফরম</h2>
								<h4 class="bold">
									<span style="color: #000">পদের নাম : <i>${recruitment.designationName}</i></span>&nbsp;&nbsp;
								...
								<div class="row form-group">
									...
									<div class="col-sm-2">
										<div class="photoContainer">
											<img src="${pageContext.request.contextPath}/static/images/img_avatar.png" alt="Avatar" id="userPhoto" class="img-thumbnail image">
											<div class="middle">
												<div class="text">
													<label
								...
								<div class="row form-group">
									...
									<div class="col-md-3">
										<sf:input type="text" path="motherNameBan" name="motherNameBan" id="motherNameBan" class="form-control" placeholder="" />
										<sf:errors path="motherNameBan" cssClass="error" />
									</div>
									<label class="col-md-3 label-title">৯. পিতার নাম :</label>
									<div class="col-md-3">
										<sf:input type="text" path="fatherNameBan" name="fatherNameBan" id="fatherNameBan" class="form-control" placeholder="" />
										<sf:errors path="fatherNameBan" cssClass="error" />
									</div>
								</div>
								<!--Current Address -->
								<div class="addressGroup">
									...
									<div class="row form-group">
										...
										<div class="col-md-3">
											<sf:input type="text" path="address[0].postCode" name="address[0].postCode" id="postCode0" class="form-control" placeholder="বর্তমান" />
								...
								<div class="addressGroup">
									...
									<div class="row form-group">
										<label class="col-md-3 label-title">পোস্টকোড নম্বর :</label>
										<div class="col-md-3">
											<sf:input type="text" path="address[1].postCode" name="address[1].postCode" id="postCode1" class="form-control" placeholder="স্থায়ী" />
								...
								<div class="row form-group">
									...
									<div class="col-md-3">
										<sf:input type="text" path="user.phone" name="user.phone" id="phone" class="form-control" placeholder="মোবাইল/ টেলিফোন নম্বর" />
								...
								<ul class="education-list">
									<li>
										...
										<div class="row form-group">
											...
											<div class="col-md-4">
												<sf:input type="text" path="educationalQualification[0].gradeOrDivision" name="educationalQualification[0].gradeOrDivision" id="gradeOrDivision" class="form-control" placeholder=""/>
												<sf:errors path="educationalQualification[0].gradeOrDivision" cssClass="error" />
											</div>
										</div>
									</li>
								</ul>
...
//			            $("#uploadPhoto").fadeIn("slow");
	...
	$( "#applyToJob" ).validate({
		...
		messages: {
			...
			nidNo:{
				required: "জাতীয় পরিচয় নম্বর লিখুন",
				number: "অবশ্যই নম্বর দিতে হবে"
			},
			bridNo:{
				required: "জন্ম নিবন্ধন নম্বর লিখুন",
				number: "অবশ্যই নম্বর দিতে হবে"
			},
			dob:{
				required: "জন্ম তারিখ সিলেক্ট করুন",
				future: "সঠিক জন্ম তারিখ সিলেক্ট করুন"
			},
			placeOfBirth:{
				required: "জন্মস্থান সিলেক্ট করুন",
				integer: "জন্মস্থান সিলেক্ট করুন"
			},
			motherNameBan:{
				required: "মাতার নাম লিখুন"
			},
			fatherNameBan:{
				required: "পিতার নাম লিখুন"
			},
			'address[0].districtId':{
				required: "জেলা   সিলেক্ট করুন",
				integer: "জেলা   সিলেক্ট করুন"
			},
			'address[0].upazilaId':{
				required: "উপজেলা  সিলেক্ট করুন",
				integer: "উপজেলা  সিলেক্ট করুন"
			},
			'address[0].postCode':{
				required: "পোস্টকোড নম্বর লিখুন",
				number: "পোস্টকোড সংখ্যায় লিখুন"
			},
			'address[0].postOffice':{
				required: "ডাকঘর লিখুন"
			},
			'address[0].unionName':{
				required: "ইউনিয়ন/ওয়ার্ড লিখুন"
			},
			'address[0].village':{
				required: "গ্রাম/পাড়া/মহল্লা লিখুন"
			},
			'address[0].homeAndRoadNo':{
				required: 'বাসা ও সড়ক (নাম/ নম্বর) লিখুন'
			},
			'address[1].districtId':{
				required: "জেলা   সিলেক্ট করুন",
				integer: "জেলা   সিলেক্ট করুন"
			...
			'user.email':{
				required: "ই-মেইল লিখুন",
				email: "সঠিক ই-মেইল লিখুন"
			},
			nationality:{
				required: "জাতীয়তা লিখুন"
			},
			genderId:{
				required: "জেন্ডার সিলেক্ট করুন"
			},
			religionId:{
				required: "ধর্ম সিলেক্ট করুন",
				integer: "ধর্ম সিলেক্ট করুন"
			},
			occupationId:{
				required: "পেশা সিলেক্ট করুন",
				integer: "পেশা সিলেক্ট করুন"
			},
			additionalQualification:{
				required: "অতিরিক্ত যোগ্যতা লিখুন"
			},
			experience:{
				required: "অভিজ্ঞতার বিবরণ লিখুন"
			},
			quotaId:{
				required: "কোটাতে টিক দিন"
			},
			'payment.paymentNo':{
				required: "চালান/ ব্যাঙ্ক ড্রাফট/ পে-অর্ডার নম্বর লিখুন"
			},
			'payment.paymentDate':{
				required: "তারিখ সিলেক্ট করুন",
				future: "সঠিক তারিখ সিলেক্ট করুন"
			},
			'payment.bankName':{
				required: "ব্যাংকের নাম লিখুন"
			},
			'payment.brunchName':{
				required: "শাখার নাম লিখুন"
			},
			divisionalCandidateId:{
				required: "বিভাগীয় প্রার্থী কিনা টিক দিন"
			}
		}
	});
